       ...
       <div class="nav-tabs-alt no-js-hide new-nav-tab-wrap">
        <ul class="nav nav-tabs nav-justified box-shadow-wrap-normal tablist new-nav-tab" role="tablist">
            <li  data-index="0" class="active" role="presentation"> <a  data-target="#widget-tabs-4-hots" role="tab"
                                                                   aria-controls="widget-tabs-4-hots" aria-expanded="true" data-toggle="tab"><div class="sidebar-icon" data-toggle="tooltip" title="<?php _me("热门文章") ?>" data-container="body"><i data-feather="thumbs-up"></i><span class="sr-only"><?php _me("热门文章") ?></span></div> </a></li>
            <?php if (COMMENT_SYSTEM == 0): ?>
                <li role="presentation" data-index="1"> <a data-target="#widget-tabs-4-comments" role="tab" aria-controls="widget-tabs-4-comments" aria-expanded="false" data-toggle="tab"><div data-toggle="tooltip" title="<?php _me("最新评论") ?>" data-container="body" class="sidebar-icon"><i  data-feather="message-square"></i><span class="sr-only"><?php _me("最新评论") ?></span></div>  </a></li>
            <?php endif; ?>
            <li data-index="<?php echo (COMMENT_SYSTEM!=0)?1:2?>" role="presentation"> <a data-target="#widget-tabs-4-random" role="tab" aria-controls="widget-tabs-4-random" aria-expanded="false" data-toggle="tab"> <div data-toggle="tooltip" title="<?php _me("随机文章") ?>" data-container="body" class="sidebar-icon"><i data-feather="gift"></i><span class="sr-only"><?php _me("随机文章") ?></span></div>
             </a></li>
          ...
          <li class="list-group-item">
              ...
              <div class="clear">
                  ...
                  <small class="text-muted">
                      <span>
                          <?php
                              $content = CommentContent::postCommentContent(Markdown::convert($comments2->text),
                              $this->user->hasLogin(),"","","");
...
<!--            <h5 class="widget-title m-t-none text-md">--><?php //_me("随机文章") ?><!--</h5>-->
      ...
      <section id="blog_info" class="widget widget_categories wrapper-md padder-v-none clear">
       <h5 class="widget-title m-t-none"><?php _me("博客信息") ?></h5>
      ...
      <?php else: ?>
          ...
          <section id="tag_cloud-post" class="widget widget_tag_cloud wrapper-md clear">
              <h5 class="widget-title m-t-none"><?php _me("文章标签") ?></h5>
              <div class="tags l-h-2x panel wrapper-sm padder-v-ssm">
                  <?php $this->tags(' ', true, _mt("暂无标签")); ?>
              </div>
          </section>
          <?php echo PostContent::returnTOC(false,true) ?>
