...
if (@$_POST["action"] == "get_action" || !@mget()->typecho_content == true){
...
<!--    <meta name="apple-mobile-web-app-status-bar-style" content="default">-->
    ...
    <script type="text/javascript">
        ...
        window['LocalConst'] = {
            ...
            COMMENT_CONTENT_LEGAL_INFO: '<?php _me("无法获取当前评论(评论已复制到剪切板)，可能原因如下：") ?>',
            COMMENT_NOT_IN_FIRST_PAGE:'<?php _me("尝试请前往评论第一页查看"); ?>',
            COMMENT_NOT_BELONG_CURRENT_TAG:'<?php _me("当前评论不属于该标签，请关闭标签筛选后查看"); ?>',
            ...
            EDIT:'<?php _me("编辑");?>',
            DELETE:'<?php _me("删除");?>',
            OPERATION_CONFIRMED:'<?php _me("确认");?>',
            OPERATION_CANCELED:'<?php _me("取消");?>',

            TAG_EDIT_TITLE: '<?php _me("编辑提示");?>',
            TAG_EDIT_DESC: '<?php _me("请输入修改后的标签名称（如果输入标签名称已存在，则会合并这两个标签）："); ?>',
            TAG_DELETE_TITLE: '<?php _me("删除提示");?>',
            TAG_DELETE_DESC: '<?php _me("确认要删除该标签吗，删除该标签的同时会删除与该标签绑定的评论列表");?>',

            CROSS_DELETE_DESC:'<?php _me("确认删除该条时光机吗？将无法恢复");?>',
            ...
            EDITOR_CHOICE: '<?php echo PostContent::getPostParseWay(); ?>',
            ...
            PLUGIN_URL:'<?php echo $options->pluginUrl; ?>',
            ...
            CALENDAR_GITHUB:'<?php echo Utils::getExpertValue("calendar_github") ?>',
            LATEST_POST_TIME:'<?php echo Utils::getLatestTimestamp() ?>',
            LATEST_TIME_COMMENT_TIME:'<?php echo Utils::getLatestTimeCommentTimestamp() ?>',
            LEFT_LOCATION: '<?php echo Utils::getExpertValue("left_location",true) ?>',

            INPUT_NEW_TAG:'<?php _me("输入结束后加空格创建新标签"); ?>'
        };
