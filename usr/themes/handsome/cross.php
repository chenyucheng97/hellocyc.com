...
<?php
require_once __TYPECHO_ROOT_DIR__ . __TYPECHO_PLUGIN_DIR__ . '/Handsome/cache/driver/controller/tag_util.php';
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="pull-right pull-none-xs text-center">
                                    <a class="m-b-md inline m">
                                        ...
                                        <small class="bg-second-text"><?php _me("说说") ?></small>
                                    </a>
                                    <a class="m-b-md inline m">
                                        <span class="h3 block font-bold"><?php echo ($tag_list) ? count($tag_list) : 0 ?></span>
                                        <small class="bg-second-text"><?php _me("标签") ?></small>
                                    </a>
<!--                                    <a class="m-b-md inline m">-->
<!--                                        <span class="h3 block font-bold">--><?php //$stat->publishedCommentsNum() ?><!--</span>-->
<!--                                        <small class="bg-second-text">--><?php //_me("天数") ?><!--</small>-->
<!--                                    </a>-->
                                </div>
                            </div>
                        </div>
            ...
            <div class="col bg-white-only lter bg-auto w-md" id="rightAside">
                <div class="wrapper">
                    <div class="padder-md">
...
<script>
    $("#header_right .dropdown .badge.up").fadeTo(0,0)
