...
class CDN_Config
{
    ...
    const TIME_DEBUG = "gAAAAABk3gNxccUncP0wiWz4nIOE3YgY9VZcgVIyhDzZ65UMLkdSOSne7KSOyvdI9We4TeNXoQ_6wig93EXdLklEZuBjUnLmdg==";   #请勿修改该变量，否则可能会导致一些问题出现
    ...
    const BOOT_CDN = '
{
  ...
  "js": {
    ...
    "vditor": "https://cdn.jsdelivr.net/npm/vditor@3.9.4",
    "echart": "https://cdn.bootcdn.net/ajax/libs/echarts/4.5.0",
    "highlight": "https://lf3-cdn-tos.bytecdntp.com/cdn/expire-1-M/highlight.js/10.7.3"
  }
}
    ';
